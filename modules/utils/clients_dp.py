"""
Módulo de agregación con ruido para DP de localización.

Dp_Agg agrega ruido a las representaciones de hiper-aristas (loc_emb) en función
de la frecuencia con que cada hiper-arista aparece en datos reales/falsos.
Esto reduce el riesgo de inferencia de presencia de un usuario en una ubicación.
"""
...
class Dp_Agg(nn.Module):
    ...
    def forward(self, loc_emb, fake_loc, real_loc):
        ...
        #         loc_noise[loc] += noise[i]/edge_cnt[loc]
        #         i += 1
        # Suma de ruido gaussiano escalado por conteos
