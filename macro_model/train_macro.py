"""
Entrenamiento del modelo macro (regional) para obtener embeddings de epidemia
por región en el tiempo. Estos embeddings se pueden acoplar al modelo
individual (ver `train.py` con `model_args.macro=true`).
"""
...
def main():
    ...
    for epoch in range(Epoch):
        ...
        if 1000 * epoch_loss / len(train_data) < 6000:
            break
    # Test Model y guardado de embeddings de regiones
    my_net.eval()
    with torch.no_grad():
        MAE, MAPE, RMSE = [], [], []
